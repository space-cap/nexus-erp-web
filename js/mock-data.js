window.erpMock = {
  ...
  inventory: [
    { item: "알루미늄 하우징 A형", warehouse: "원자재 창고", current: 1840, safety: 900, available: 1720, status: "정상", lastDate: "2026-05-29" },
    { item: "컨트롤 PCB V2", warehouse: "전자부품 창고", current: 312, safety: 450, available: 288, status: "부족", lastDate: "2026-05-30" },
    { item: "모터 브라켓", warehouse: "가공품 창고", current: 760, safety: 500, available: 690, status: "정상", lastDate: "2026-05-28" },
    { item: "센서 케이블 1.5M", warehouse: "전자부품 창고", current: 128, safety: 300, available: 120, status: "부족", lastDate: "2026-05-27" },
    { item: "패킹 고무", warehouse: "원자재 창고", current: 2200, safety: 1000, available: 2140, status: "정상", lastDate: "2026-05-21" }
  ],
  orders: [
    { no: "SO-260529-001", customer: "한빛정밀", orderDate: "2026-05-29", dueDate: "2026-06-07", owner: "최영업", amount: 28600000, status: "진행" },
    { no: "SO-260528-004", customer: "우진산업", orderDate: "2026-05-28", dueDate: "2026-06-04", owner: "김관리", amount: 54800000, status: "대기" },
    { no: "SO-260524-002", customer: "세림전자", orderDate: "2026-05-24", dueDate: "2026-05-31", owner: "최영업", amount: 19400000, status: "지연" },
    { no: "SO-260520-003", customer: "다온테크", orderDate: "2026-05-20", dueDate: "2026-06-12", owner: "김관리", amount: 16500000, status: "완료" },
    { no: "SO-260518-007", customer: "한빛정밀", orderDate: "2026-05-18", dueDate: "2026-06-01", owner: "최영업", amount: 30200000, status: "진행" }
  ],
  purchase: [
    { no: "PO-260530-002", vendor: "동양소재", orderDate: "2026-05-30", dueDate: "2026-06-03", owner: "박구매", amount: 14200000, status: "대기" },
    { no: "PO-260529-001", vendor: "제이피전자", orderDate: "2026-05-29", dueDate: "2026-06-05", owner: "박구매", amount: 38900000, status: "진행" },
    { no: "PO-260526-005", vendor: "삼우케이블", orderDate: "2026-05-26", dueDate: "2026-05-30", owner: "이자재", amount: 7800000, status: "지연" },
    { no: "PO-260522-003", vendor: "우진고무", orderDate: "2026-05-22", dueDate: "2026-06-02", owner: "이자재", amount: 4200000, status: "완료" },
    { no: "PO-260520-008", vendor: "한성가공", orderDate: "2026-05-20", dueDate: "2026-06-10", owner: "박구매", amount: 11800000, status: "진행" }
  ],
  production: [
